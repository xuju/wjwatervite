...
import { useLayerList } from '@/utils/hooks';
...
export const renderDom = (view: MapView, attr: PointAttr, div: HTMLElement) => {
...
const Business = () => {
  ...
  return (
    <div className="business">
      <MapBox getView={setView} onClick={setResults} showPosition={true} />
      {view && <AddLayer view={view} allLayers={listLayers} />}
      {mapType.type === '2D' && view && (
        <Tools view={view} clickCallback={setSelectToolBar} type={selectToolBar} />
      )}
      {mapType.type === '3D' && view && (
        <SceneTools view={view} clickCallback={setSelectToolBar} type={selectToolBar} />
      )}
